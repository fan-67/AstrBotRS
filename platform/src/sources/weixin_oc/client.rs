...
impl WeixinOCClient {
    ...
    pub async fn get_typing_config(&self, user_id: &str, context_token: &str) -> Result<Value, String> {
        self.request_json(
            "POST",
            "ilink/bot/getconfig",
            None,
    ...
    pub async fn send_typing_state(&self, user_id: &str, ticket: &str, cancel: bool) -> Result<Value, String> {
        self.request_json(
            "POST",
